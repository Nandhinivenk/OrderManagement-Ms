...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OrderFlowNotFoundException.class)
    public ResponseEntity<Map<String, String>> handleOrderFlowNotFoundException(OrderFlowNotFoundException ex) {
